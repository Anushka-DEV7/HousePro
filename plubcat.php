...
<html>
<head>
<title> Plumbing services page</title>
...
<nav class = "navv">
	  ...
	  <ul>
		 ...
		 <li class =  "navli"><a href= "ordplu.php" class ="btn1">BOOK NOW </a></li>
...
<div class="services">
        <h1><span> Plumbing </span> Services  </h1>
		<p> Your urgent plumbing needs , our priority </p>
 </div>
  <?php

include "inv.php";
$query = "select * from services where service_cate = 'Plumbing' ";
...
<?php	  
   ...
   <div class ="col-md-4">
     <div class ="service-box">
	  ...
	  <br>
	  <img src="img/tap.jpeg" class= "logo0" alt="">
	  <br>
