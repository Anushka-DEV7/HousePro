...
<html>
<head>
<title> Cleaning services page</title>
...
<nav class = "navv">
	  ...
	  <ul>
		 ...
		 <li class =  "navli"><a href= "ordcle.php" class ="btn1">BOOK NOW </a></li>
...
<div class="services">
		...
		<p> We deliver spotless houses in HousePro ! </p>
 </div>
  <?php

include "inv.php";
$query = "select * from services where service_cate = 'Cleaning' ";
...
<?php	  
   ...
   <div class ="col-md-4">
     <div class ="service-box">
	  ...
	  <br>
	  <img src="img/deepclean.jpeg" class= "logo0" alt="">
	  <br>
