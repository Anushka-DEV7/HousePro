...
<html>
<head>
<title> Electrical services page</title>
...
<nav class = "navv">
	  ...
	  <ul>
		 ...
		 <li class =  "navli"><a href= "ordele.php" class ="btn1">BOOK NOW </a></li>
...
<div class="services">
        <h1><span> Electrical </span> Services  </h1>
		<p> Electrical Repair , Done Right ! </p>
 </div>
   <?php

include "inv.php";
$query = "select * from services where service_cate = 'Electrician' ";
...
<?php	  
   ...
   <div class ="col-md-4">
     <div class ="service-box">
	  ...
	  <br>
	  <img src="img/switch.jpeg" class= "logo0" alt="">
	  <br>
