...
<html>
<head>
<title> Painting and Waterproofing services page</title>
...
<nav class = "navv">
	  ...
	  <ul>
		...
		<li class = "navli"><a href= "sercatog.php" class= "btn1"> Lifestyle care Services </a></li>
		 ...
		 <li class =  "navli"><a href= "ordpai.php" class ="btn1">BOOK NOW </a></li>
...
<div class="services">
        <h1><span> Painting and Waterproofing</span> Services  </h1>
		<p> Bringing more life to your Surrounding ! </p>
 </div>
  <?php

include "inv.php";
$query = "select * from services where service_cate = 'Painting and Waterproofing ' ";
...
<?php	  
   ...
   <div class ="col-md-4">
     <div class ="service-box">
	  ...
	  <br>
	  <img src="img/pain.jpeg" class= "logo0" alt="">
	  <br>
