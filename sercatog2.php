...
<nav class = "navv">
	  ...
	  <ul>
	     ...
	     <li class = "navli"><a href= "custsignup.php" class= "btn1"> Log in </a></li>
	     <li class = "navli"><a href= "custsignin.php" class= "btn1"> Register </a></li>
 ...
 <div class="row">
   <div class ="col-md-4">
     <div class ="service-box">
	  ...
	  <br>
	  <div class ="divbtn">
	  <a href= "custsignup.php" class ="btn"><font class = "f" >BOOK NOW </font> </i></a> 
	  </div>
    </div>
   </div>
	<div class ="col-md-4">
