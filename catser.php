...
<html>
<head>
<title> Catering  services page</title>
...
<nav class = "navv">
	  ...
	  <ul>
	    <li class = "navli"><a href= "hphomepage.html" class= "btn1"> Home </a></li>
		 ...
		 <li class =  "navli"><a href= "ordcat.php" class ="btn1">BOOK NOW </a></li>
...
<div class="services">
        <h1><span> Personalised Catering </span> Services  </h1>
		<p> Bringing more life to your Surrounding ! </p>
 </div>
  <?php

include "inv.php";
$query = "select * from services where service_cate = 'Personalized Catering' ";
...
<?php	  
   ...
   <div class ="col-md-4">
     <div class ="service-box">
	  ...
	  <br>
	  <img src="img/chef.jpeg" class= "logo0" alt="">
	  <br>
